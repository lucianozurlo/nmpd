      ...
      (s.csstransforms3d = function () {
         ...
         return (
            a &&
               ...
               y(
                  '@container (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}',
                  function (b, c) {
         ...
         for (
            t &&
               ...
               0 < this.rows &&
                  (o =
                     ((g =
                        (this.offY - this.border - this.settings.margins * this.rows) / this.rows) *
...
class GridToFullscreenEffect {
   ...
   recalculateUniforms(e) {
      if (-1 === this.currentImageIndex) return;
      const n =
            this.itemsWrapperChildren[this.currentImageIndex].children[0].getBoundingClientRect(),
