...
---------------------------------------------------*/
  ...
  function CustomFunction() {
    ...
    function loadImagesForPage(pageName) {
      const jsonPath = `/projects/_json/${pageName}.json`;
      ...
      fetch(jsonPath)
        ...
        .then(data => {
          const seqPaths = data.seq
            ? data.seq.flatMap(seq => loadSequenceImages(seq.prefix, seq.start, seq.end, pageName))
            : [];

          const vidPaths = data.vid ? data.vid.map(video => `/projects/_vid/${video}`) : [];

          const introPaths = data.intro ? data.intro.map(image => `/projects/_intro/${image}`) : [];
    ...
    function initOnFirstLoad() {
      imagesLoaded('body', function () {
        ...
        setTimeout(function () {
          ...
          gsap.to($('.showcase-carousel .nmp-slider .nmp-slide .slide-inner'), {
            duration: 2,
            opacity: 1,
            delay: 0.75,
            ease: Power4.easeOut
          ...
          gsap.set($('.showcase-carousel .nmp-slider .nmp-slide-prev-two .slide-inner'), {
            yPercent: 260
          });
          gsap.to($('.showcase-carousel .nmp-slider .nmp-slide-prev-two .slide-inner'), {
            duration: 1.8,
            yPercent: 0,
            delay: 0.6,
            ease: Power4.easeOut
          ...
          gsap.set($('.showcase-carousel .nmp-slider .nmp-slide-prev .slide-inner'), {
            yPercent: -210
          });
          gsap.to($('.showcase-carousel .nmp-slider .nmp-slide-prev .slide-inner'), {
            duration: 1.8,
            yPercent: 0,
            delay: 0.65,
            ease: Power4.easeOut
          ...
          gsap.set($('.showcase-carousel .nmp-slider .nmp-slide-active .slide-inner'), {
            yPercent: 160
          });
          gsap.to($('.showcase-carousel .nmp-slider .nmp-slide-active .slide-inner'), {
            duration: 1.8,
            yPercent: 0,
            delay: 0.7,
            ease: Power4.easeOut,
          ...
          gsap.set($('.showcase-carousel .nmp-slider .nmp-slide-next .slide-inner'), {
            yPercent: -210
          });
          gsap.to($('.showcase-carousel .nmp-slider .nmp-slide-next .slide-inner'), {
            duration: 1.8,
            yPercent: 0,
            delay: 0.65,
            ease: Power4.easeOut
          ...
          gsap.set($('.showcase-carousel .nmp-slider .nmp-slide-next-two .slide-inner'), {
            yPercent: 260
          });
          gsap.to($('.showcase-carousel .nmp-slider .nmp-slide-next-two .slide-inner'), {
            duration: 1.8,
            yPercent: 0,
            delay: 0.6,
            ease: Power4.easeOut
          ...
          gsap.to($('.showcase-gallery .nmp-slider .nmp-slide .slide-inner'), {
            duration: 2,
            opacity: 1,
            delay: 0.2,
            ease: Power4.easeOut
  ...
  function PageLoadActions() {
    ...
    if (!isMobile()) {
      $('#project-nav .next-ajax-link-project').mouseenter(function (e) {
        var $this = $(this);
        $('#ball').append(
          '<p class="first">' + $this.data('firstline') + '</p>' + '<p>' + $this.data('secondline') + '</p>'
        );
        gsap.to('#ball', {
          duration: 0.3,
          borderWidth: '2px',
    ...
    if (!$('body').hasClass('disable-ajaxload')) {
      ...
      $('.next-ajax-link-project').on('click', function () {
        ...
        $('header').removeClass('white-header');
        $('#app').remove();
        $('#project-nav .next-project-image-wrapper').addClass('temporary').appendTo('body');
    ...
    if ($('.showcase-slider').length > 0) {
      ...
      if ($('.showcase-slider').hasClass('rotate-caption')) {
        ...
        for (let i = 0; i < arrTitles.length; i++) {
          ...
          if (i != 0) {
            ...
            slider.tl
              .to(rowTitleWrapper, {yPercent: 0, duration: transitionduration}, '<')
      ...
      $('.trigger-item').on('click', function () {
        ...
        setTimeout(function () {
          ...
          var moveTitle =
            $('.temporary-hero .inner').outerHeight() / 2 - $('.temporary-hero .slide-title').outerHeight() * 0.5 - 1;
          gsap.to($('.temporary-hero .slide-title'), {
            duration: 1.5,
            y: moveTitle,
            opacity: 1,
...
---------------------------------------------------*/
  ...
  function ShowcaseLists() {
    if ($('.showcase-lists').length > 0) {
      ...
      document
        .querySelector('.nmp-slider-wrapper.showcase-lists .nmp-sync-slider-wrapper')
  ...
  function ShowcaseGallery() {
    if ($('.showcase-gallery').length > 0) {
      ...
      const showGrid = () => {
        ...
        gsap.to($('footer .link-text, .nmp-pagination, .progress-info, #filters-wrapper'), {
          duration: 0.3,
          opacity: 0,
          y: 30,
          stagger: -0.05,
