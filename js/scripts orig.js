         ...
         imagesLoaded('body', function () {
            ...
            setTimeout(function () {
               ...
               gallerySlideClasses.forEach(function (gallerySlideClass, index) {
                  var gallerySlide = $(
                     '.showcase-gallery .clapat-slider ' + gallerySlideClass + ' .slide-inner'
                  );
      ...
      if ($('.showcase-carousel').length > 0) {
               ...
               init: function () {
                  if ($('body').hasClass('show-loader')) {
                     imagesLoaded('body', function () {
                        ...
                        gsap.to(
                           $('.showcase-carousel .clapat-slider .clapat-slide-prev .slide-inner'),
                           { duration: 1.2, yPercent: 0, delay: 0.15, ease: Power4.easeOut }
                        );
         ...
         $('.trigger-item').on('click', function () {
            ...
            gsap.to(
               ...
               { duration: 0.3, y: 30, opacity: 0, stagger: -0.03, ease: Power2.easeInOut }
            );
      ...
      if ($('.showcase-slider').length > 0) {
         ...
         if ($('.showcase-slider').hasClass('rotate-caption')) {
            ...
            slider.tl.fromTo(
               ...
               { yPercent: 0, rotationX: 0, z: 0, opacity: 1, duration: transitionduration },
               '<'
            );
         ...
         $('.trigger-item').on('click', function () {
            ...
            setTimeout(function () {
               ...
               var clonedListItem = $(
                  '.clapat-sync-slider-viewport .clapat-sync-slide:eq(' + clickedIndex + ')'
               );
...
---------------------------------------------------*/
   ...
   function ShowcaseLists() {
      if ($('.showcase-lists').length > 0) {
         ...
         document
            .querySelector('.clapat-slider-wrapper.showcase-lists .clapat-sync-slider-wrapper')
