		...
		function initOnFirstLoad() {
			...
			imagesLoaded('body', function() {
				...
				setTimeout(function(){
					...
					gsap.set($(".showcase-carousel .nmp-slider .slide-inner"), {opacity:0});
					gsap.to($(".showcase-carousel .nmp-slider .nmp-slide .slide-inner"), {duration: 2, opacity:1, delay:0.75, ease:Power4.easeOut});
					
					gsap.set($(".showcase-carousel .nmp-slider .nmp-slide-prev-two .slide-inner"), {yPercent:260});
					gsap.to($(".showcase-carousel .nmp-slider .nmp-slide-prev-two .slide-inner"), {duration: 1.8, yPercent:0, delay:0.6, ease:Power4.easeOut});
					
					gsap.set($(".showcase-carousel .nmp-slider .nmp-slide-prev .slide-inner"), {yPercent:-210});
					gsap.to($(".showcase-carousel .nmp-slider .nmp-slide-prev .slide-inner"), {duration: 1.8, yPercent:0, delay:0.65, ease:Power4.easeOut});
					
					gsap.set($(".showcase-carousel .nmp-slider .nmp-slide-active .slide-inner"), {yPercent:160});
					gsap.to($(".showcase-carousel .nmp-slider .nmp-slide-active .slide-inner"), {duration: 1.8, yPercent:0, delay:0.7,  ease:Power4.easeOut, onComplete: function() {
							$('body').removeClass(" disable-scroll");
						}
					});
					
					gsap.set($(".showcase-carousel .nmp-slider .nmp-slide-next .slide-inner"), {yPercent:-210});
					gsap.to($(".showcase-carousel .nmp-slider .nmp-slide-next .slide-inner"), {duration: 1.8, yPercent:0, delay:0.65, ease:Power4.easeOut});
					
					gsap.set($(".showcase-carousel .nmp-slider .nmp-slide-next-two .slide-inner"), {yPercent:260});
					gsap.to($(".showcase-carousel .nmp-slider .nmp-slide-next-two .slide-inner"), {duration: 1.8, yPercent:0, delay:0.6, ease:Power4.easeOut});
									
					// Fading In Showcase Slider elements on Finised
					gsap.set($(".showcase-slider .nmp-slider .slide-inner"), {opacity:0});
					gsap.to($(".showcase-slider .nmp-slider .nmp-slide .slide-inner"), {duration: 1.2, opacity:1, scale:1, delay:0.7, ease:Power4.easeOut});
					...
					gsap.to($(".showcase-gallery .nmp-slider .nmp-slide .slide-inner"), { duration: 2, opacity: 1, delay: 0.2, ease: Power4.easeOut });
					
					var gallerySlideClasses = [".nmp-slide-prev-two", ".nmp-slide-prev", ".nmp-slide-active", ".nmp-slide-next", ".nmp-slide-next-two"];
					
					gallerySlideClasses.forEach(function(gallerySlideClass, index) {
						var gallerySlide = $(".showcase-gallery .nmp-slider " + gallerySlideClass + " .slide-inner");
					...
					gsap.set($("#filters-wrapper, .nmp-pagination, .cp-button-prev, .cp-button-next, .progress-info, footer .link-text"), {opacity:0});
					gsap.to($("#filters-wrapper, .nmp-pagination, .cp-button-prev, .cp-button-next, .progress-info, footer .link-text"), {duration: 0.4, opacity:1, delay:0.8, ease:Power3.easeOut});
					
					var bullets = document.querySelectorAll(".showcase-carousel .nmp-pagination-bullet");
	...
	function ShowcaseCarousel() {
		...
		if( $('.showcase-carousel').length > 0 ){
					...
					init : function() {
						...
						if ($('body').hasClass("show-loader")) {
							...
							imagesLoaded('body', function() {
								...
								gsap.to($(".showcase-carousel .nmp-slider .nmp-slide .slide-inner"), {duration: 1.2, opacity:1, delay:0.2, ease:Power4.easeOut});					
								
								
								gsap.set($(".showcase-carousel .nmp-slider .nmp-slide-prev-two .slide-inner"), {yPercent:70});
								gsap.to($(".showcase-carousel .nmp-slider .nmp-slide-prev-two .slide-inner"), {duration: 1.2, yPercent:0, delay:0.1, ease:Power4.easeOut});
								
								
								gsap.set($(".showcase-carousel .nmp-slider .nmp-slide-prev .slide-inner"), {yPercent:-70});
								gsap.to($(".showcase-carousel .nmp-slider .nmp-slide-prev .slide-inner"), {duration: 1.2, yPercent:0, delay:0.15, ease:Power4.easeOut});
								
								
								gsap.set($(".showcase-carousel .nmp-slider .nmp-slide-active .slide-inner"), {yPercent:70});
								gsap.to($(".showcase-carousel .nmp-slider .nmp-slide-active .slide-inner"), {duration: 1.2, yPercent:0, delay:0.2,  ease:Power4.easeOut, onComplete: function() {
										$('body').removeClass(" disable-scroll");
									}
								});
								
								
								gsap.set($(".showcase-carousel .nmp-slider .nmp-slide-next .slide-inner"), {yPercent:-70});
								gsap.to($(".showcase-carousel .nmp-slider .nmp-slide-next .slide-inner"), {duration: 1.2, yPercent:0, delay:0.15, ease:Power4.easeOut});
								
								
								gsap.set($(".showcase-carousel .nmp-slider .nmp-slide-next-two .slide-inner"), {yPercent:70});
								gsap.to($(".showcase-carousel .nmp-slider .nmp-slide-next-two .slide-inner"), {duration: 1.2, yPercent:0, delay:0.1, ease:Power4.easeOut});
								
								gsap.to($("#filters-wrapper, .nmp-pagination, .cp-button-prev, .cp-button-next, .progress-info, footer .link-text"), {duration: 0.5, opacity:1, delay:0.4, ease:Power3.easeOut});
			...
			const showGrid = () => {
				...
				gsap.to($("footer .link-text, .nmp-pagination, .progress-info"), {duration: 0.3, opacity:0, y:30, stagger:-0.05, ease:Power2.easeInOut});
			...
			const hideGrid = () => {
				...
				Flip.from(flipstate, {
					...
					onComplete: function() {
						...
						const triggeredItem = document.querySelector('.nmp-slide.triggered-item');
				...
				gsap.to($("footer .link-text, .nmp-pagination, .progress-info"), {duration: 0.3, opacity:1, y:0, stagger:0.05, delay:0.4, ease:Power2.easeInOut});
				gsap.to('#ball', {duration: 0.2, borderWidth: '4px', scale:0.5, borderColor:'#999999', backgroundColor:'transparent'});
				gsap.to('#ball-loader', {duration: 0.2, borderWidth: '4px', top: 0, left: 0});
				$("#ball").removeClass("with-blur");
				$('#ball p').remove();
			...
			const getDOMElements = () => {
				...
				return {					
					items: items,					
					grid: gridItems,					
					currentItem: new Item( document.querySelector('.nmp-slide.triggered-item') ),
				...
				items.forEach((triggerItem) => {
					...
					triggerItem.addEventListener('click', (event) => {
						...
						if( $('.showcase-carousel').length > 0 ){
							...
							event.currentTarget.closest('.nmp-slide').classList.add('triggered-item');
							showGrid();
						}
					});
			...
			if (!isMobile()) {				
				...
				$(".showcase-carousel.preview-mode-enabled .nmp-slide .slide-inner").on('mouseenter', function() {	
				...
				$(".showcase-carousel .nmp-slide .slide-inner").on('mouseenter', function() {					
				...
				$(".showcase-carousel .nmp-slide .slide-inner").on('mouseleave', function() {
...
---------------------------------------------------*/
	...
	function ShowcaseSlider() {
		...
		if( $('.showcase-slider').length > 0 ){
			...
			gsap.set($(".showcase-slider .nmp-slider .slide-inner"), {opacity:0, scale:1.1});
			gsap.set($(".showcase-slider .slide-title span"), {y: 100, opacity: 0});
			gsap.set($("#filters-wrapper, .nmp-pagination, .cp-button-prev, .cp-button-next, .progress-info, footer .link-text"), {opacity:0});
					...
					init : function() {
						...
						if ($('body').hasClass("show-loader")) {
							...
							imagesLoaded('body', function() {
								...
								gsap.to($(".showcase-slider .nmp-slider .nmp-slide .slide-inner"), {duration: 1.2, opacity:1, scale:1, delay:0, ease:Power4.easeOut});	
			...
			arrTitles = gsap.utils.toArray('.nmp-slider-wrapper .nmp-sync-slider .nmp-sync-slide');
			...
			$('.trigger-item').on( 'click', function() {
					...
					setTimeout( function(){
						...
						var clonedListItem = $('.nmp-sync-slider-viewport .nmp-sync-slide:eq(' + clickedIndex + ')');
		...
		if( $('.showcase-portfolio').length > 0 ){
			...
			function listView() {
				...
				if (!grid.classList.contains('list-grid')) {
					...
					if (isMobile()) {
						gsap.to($('.nmp-item .slide-caption'), {duration: 0.5, opacity:0, y:0, stagger: 0.05, ease: "power3.inOut"});
					}
					
					heroFooter.classList.add('list-enable');
					
					gsap.to($('.nmp-item .section-image'), {duration: 0.5, opacity:0, scale:0.5, stagger: 0.05, ease: "power3.inOut",
						onComplete: function() {												
							...
							var slideInners = document.querySelectorAll('.nmp-item .slide-inner');
							...
							if ($('#page-content').hasClass('light-content')) {
								gsap.to($('.nmp-item'), {duration: 0.5, borderBottomColor: borederColorWhite, stagger: 0.05, ease: "power3.inOut"});
							} else if ($('#page-content').hasClass('dark-content')) {
								gsap.to($('.nmp-item'), {duration: 0.5, borderBottomColor: borederColorBlack, stagger: 0.05, ease: "power3.inOut"});
							}
					...
					gsap.to($('.nmp-item'), {duration: 0.3, borderBottomColor:'rgba(0,0,0,0)',  ease:Power2.easeOut});
					
					var listMasks = document.querySelectorAll('.nmp-item .slide-inner .list-mask');
					listMasks.forEach(function(listMask) {
						listMask.parentNode.removeChild(listMask);
					});
					
					gsap.to($('.nmp-item .section-image'), {duration: 0.5, width:"100%", scale:0.9, ease: "power3.inOut",
						onComplete: function() {
							...
							var flip = Flip.from(stateThumb, {
								...
								onComplete: function() {												
									ScrollTrigger.refresh();
									gsap.to($('.nmp-item .section-image'), {duration: 0.5, scale:1, opacity:1, stagger: 0.05, ease: "power3.Out"});
									if (isMobile()) {
										gsap.to($('.nmp-item .slide-caption'), {duration: 0.5, opacity:1, delay:0.2, stagger: 0.05, ease: "power3.Out"});
									}
								}
							})
			...
			if (!isMobile()) {	
				...
				$(".showcase-portfolio .nmp-item .slide-inner").on('mouseenter', function() {
					$('#ball p').remove();
					var $this = $(this);			
					gsap.to('#ball', {duration: 0.3, borderWidth: '2px', scale: 1.4, borderColor:"rgba(255,255,255,0)", backgroundColor:"rgba(255,255,255,0.1)"});
					gsap.to('#ball-loader', {duration: 0.2, borderWidth: '2px', top: 2, left: 2});
...
---------------------------------------------------*/
	...
	function ShowcaseLists() {
		...
		if( $('.showcase-lists').length > 0 ){
			...
			const slidesRoot = document.querySelector('.nmp-sync-slider .nmp-sync-slider-wrapper .nmp-sync-slider-viewport');
			const slidesList = slidesRoot.querySelectorAll('.nmp-sync-slider .nmp-sync-slide');
			...
			const clapatSyncSlider = document.querySelector('.nmp-slider-wrapper.showcase-lists .nmp-sync-slider-viewport');
			const syncSliderClone = clapatSyncSlider.cloneNode(true);
			document.querySelector(".nmp-slider-wrapper.showcase-lists .nmp-sync-slider-wrapper").appendChild(syncSliderClone); 
			...
			slider = new ClapatSlider('.showcase-lists', { 
				...
				on: {
					init : function() {						
						if ($('body').hasClass("show-loader")) {							
							gsap.to($("#filters-wrapper, .nmp-pagination, .cp-button-prev, .cp-button-next, .progress-info, footer .link-text"), {duration: 0.5, opacity:1, delay:0.3, ease:Power2.easeOut});						
						}						
					}
				} 
			});
			...
			const syncSliderCloneTranslate = document.querySelectorAll('.nmp-slider-wrapper.showcase-lists .nmp-sync-slider-wrapper > .nmp-sync-slider-viewport');
			const titleWrapper = document.querySelector('.nmp-sync-slider-wrapper')
			
			slider.tl
				.fromTo('.nmp-slider-wrapper.showcase-lists .nmp-sync-slider-wrapper', {yPercent: 0 },{ yPercent: -(100 - (100 / syncSliderCloneTranslate.length))},0)
			...
			if (!isMobile()) {				
				...
				dragWrapper.on('mousedown', function (evt) {
					dragWrapper.on('mouseup mousemove', function handler(evt) {
						if (evt.type === 'mouseup') {					  
							...
							$(".showcase-lists .nmp-sync-slide .slide-inner").on('click', function() {	
								if (!$('body').hasClass('scale-drag-y')) {
				...
				$(".showcase-lists .nmp-sync-slide .slide-inner").on('mouseenter', function() {	
					if (!$('body').hasClass('scale-drag-x')) {
						$('#ball p').remove();
						var $this = $(this);			
						gsap.to('#ball', {duration: 0.3, borderWidth: '2px', scale: 1.4, borderColor:"rgba(255,255,255,0)", backgroundColor:"rgba(255,255,255,0.1)"});
				...
				$('.nmp-sync-slide').on('mouseenter', function() {
			...
			Array.from(document.querySelectorAll('.nmp-sync-slide')).forEach(link => new HoverImgFx1(link));
	...
	function ShowcaseGallery() {
		...
		if( $('.showcase-gallery').length > 0 ){
			...
			slider = new ClapatSlider('.showcase-gallery', { 
				...
				on: {	
					init : function(slide) {
						...
						if ($('body').hasClass("show-loader")) {
							...
							imagesLoaded('body', function() {
								...
								gsap.to($(".showcase-gallery .nmp-slider .nmp-slide .slide-inner"), { duration: 0.7, opacity: 1, delay: 0.4, ease: Power2.easeOut });
								...
								gsap.to($("#filters-wrapper, .nmp-pagination, .cp-button-prev, .cp-button-next, .progress-info, footer .link-text"), {duration: 0.5, opacity:1, delay:0.4, ease:Power2.easeOut});
					...
					slideLeaveViewport : function( slide ) {						
						gsap.set($('.nmp-slider div:not(.nmp-slide-visible) .slide-events'), { y: "" });						
					},
			...
			const showGrid = () => {
				...
				gsap.to($("footer .link-text, .nmp-pagination, .progress-info, #filters-wrapper"), {duration: 0.3, opacity:0, y:30, stagger:-0.05, ease:Power2.easeInOut});
				...
				gsap.to(".nmp-slider .nmp-slide .trigger-item", { duration: 1, opacity:0, scale:0.7, ease:Power2.easeOut });
			...
			const hideGrid = () => {
				...
				gsap.to(".nmp-slider .nmp-slide .trigger-item", { duration: 0.5, opacity:1, scale:1, delay:0.2, ease: 'power3.inOut' });				
				...
				gsap.to($("footer .link-text, .nmp-pagination, .progress-info, #filters-wrapper"), {duration: 0.3, opacity:1, y:0, stagger:0.05, delay:0.4, ease:Power2.easeInOut});
			...
			if (!isMobile()) {
				...
				$(".showcase-gallery.preview-mode-enabled .nmp-slide .slide-inner").on('mouseenter', function() {	
					if (!$('body').hasClass('scale-drag-x')) {
						$('#ball p').remove();
						var $this = $(this);			
						gsap.to('#ball', {duration: 0.3, borderWidth: '2px', scale: 1.4, borderColor:"rgba(255,255,255,0)", backgroundColor:"rgba(255,255,255,0.1)"});
